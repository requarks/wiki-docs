...
3. Download the latest version of Wiki.js:
  ```powershell
  Invoke-WebRequest -Uri "https://github.com/Requarks/wiki/releases/download/v2.5.275/wiki-js-windows.tar.gz" -OutFile "wiki-js.tar.gz"
  ```
