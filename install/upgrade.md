...
5. Download the latest version of Wiki.js:
  ```powershell
  Invoke-WebRequest -Uri "https://github.com/Requarks/wiki/releases/download/2.5.274/wiki-js-windows.tar.gz" -OutFile "wiki-js.tar.gz"
  ```
