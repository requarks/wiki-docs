...
- Added page conversion functionality to switch between editors. *(thanks to the [Bern University of Applied Sciences](https://www.bfh.ch/) for sponsoring the development of this feature)*
